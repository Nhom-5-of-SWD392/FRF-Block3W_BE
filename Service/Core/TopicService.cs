...
public interface ITopicService
{
	...
	Task<Guid> Create(TopicCreateModel model);
	Task<Guid> Update(Guid id,TopicUpdateModel model);
...
public class TopicService : ITopicService
{
	...
	public async Task<Guid> Create(TopicCreateModel model)
	{
	...
	public async Task<Guid> Update(Guid id, TopicUpdateModel model)
	{
		try
		{
			var data = await GetTopicById(id);
